...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=fitbits&crid=28CA6BVUF0HDU&sprefix=fitbits%2Caps%2C101&ref=nb_sb_noss_1"
    ...
    amazon_df.to_json("./data/fitbit_toys_data.json")
    amazon_df.to_csv("./data/fitbit_data.csv", header=True, index=False)