...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=apple+ipads&crid=QP5PBVDC2URP&sprefix=apple+ipads%2Caps%2C96&ref=nb_sb_noss_1"
    ...
    amazon_df.to_json("./data/apple_ipads_data.json")
    amazon_df.to_csv("./data/apple_ipads_data.csv", header=True, index=False)