...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=camera+for+photography&crid=3DMI5EQIZAQBT&sprefix=camera+for+phot%2Caps%2C94&ref=nb_sb_ss_ts-doa-p_1_15"
    ...
    amazon_df.to_json("./data/photography_camera_data.json")
    amazon_df.to_csv("./data/photography_camera_data.csv", header=True, index=False)