...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=board+games+for+kids+and+adults&crid=15OUT5OV8WHMA&sprefix=board+games+for+kids+and+%2Caps%2C88&ref=nb_sb_ss_ts-doa-p_2_25"
    ...
    amazon_df.to_json("./data/board_games_data.json")
    amazon_df.to_csv("./data/board_games_data.csv", header=True, index=False)