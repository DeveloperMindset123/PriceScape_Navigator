...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=macbooks&crid=1D2Z9D8EEEXSW&sprefix=macbook%2Caps%2C115&ref=nb_sb_noss_1"
    ...
    amazon_df.to_json("./data/macbooks_data.json")
    amazon_df.to_csv("./data/macbooks_data.csv", header=True, index=False)