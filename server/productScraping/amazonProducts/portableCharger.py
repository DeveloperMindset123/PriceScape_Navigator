...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=portable+charger&crid=2PRMR0NID1X83&sprefix=portable+c%2Caps%2C88&ref=nb_sb_ss_ts-doa-p_2_10"
    ...
    amazon_df.to_json("./data/portable_charger_data.json")
    amazon_df.to_csv("./data/portable_charger_data.csv", header=True, index=False)