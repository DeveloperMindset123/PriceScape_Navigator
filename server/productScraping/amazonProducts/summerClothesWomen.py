...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=summer+clothes+for+women&crid=OMGC503ZOJEW&sprefix=summer+clothes+for+women%2Caps%2C112&ref=nb_sb_noss_1"
    ...
    amazon_df.to_json("./data/summer_clothes_women_data.json")
    amazon_df.to_csv("./data/summer_clothes_women_data.csv", header=True, index=False)