...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=electric+toothbrush&crid=31H5W3LXH3RM1&sprefix=elec%2Caps%2C109&ref=nb_sb_ss_ts-doa-p_1_4"
    ...
    amazon_df.to_json("./data/electric_toothbrushes_data.json")
    amazon_df.to_csv("./data/electric_toothbrushes_data.csv", header=True, index=False)