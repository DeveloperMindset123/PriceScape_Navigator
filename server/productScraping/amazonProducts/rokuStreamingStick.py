...
if __name__ == "__main__":
    ...
    URL="https://www.amazon.com/s?k=Roku+streaming+stick+2024&crid=2S468H437HTJK&sprefix=roku+streaming+stick+2024%2Caps%2C84&ref=nb_sb_noss_1"
    ...
    amazon_df.to_json("./data/roku_stick_data.json")
    amazon_df.to_csv("./data/roku_stick_data.csv", header=True, index=False)
