...
def web_qa(url_list, query):
    ...
    with open('./data/newEgg_noiseCancellingHeadphones_details.json', 'w') as f:
        json.dump(results, f, indent=4)

    print("\nResults saved to 'newEgg_noiseCancellingHeadphones_details.json'.")

if __name__ == "__main__":
    url_list = ["https://www.newegg.com/p/pl?d=noise+cancelling+headphones"]
    prompt = """
