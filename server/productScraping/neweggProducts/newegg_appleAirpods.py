...
def web_scraper(url_list, query):
    ...
    with open('./data/newEgg_appleAirpods_details.json', 'w') as f:
        json.dump(results, f, indent=4)
    print("\nResults saved to 'newEgg_appleAirpods_details.json'.")

if __name__ == "__main__":
    url_list = ["https://www.newegg.com/p/pl?d=apple+airpods"]
    prompt = """
    ...
    web_scraper(url_list=url_list, query=prompt)
