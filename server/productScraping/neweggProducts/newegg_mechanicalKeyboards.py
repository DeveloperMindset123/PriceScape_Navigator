...
def web_scraper(url_list, query):
    ...
    with open('./data/newEgg_mechanicalKeyboards_details.json', 'w') as f:
        json.dump(results, f, indent=4)

    print("\nResults saved to 'newEgg_mechanicalKeyboards_details.json'.")

if __name__ == "__main__":
    url_list = ["https://www.newegg.com/p/pl?d=mechanical+keyboards"]
    prompt = """
