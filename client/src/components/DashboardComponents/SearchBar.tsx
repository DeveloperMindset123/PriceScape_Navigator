...
//TODO: Clicking on the AiOutlineSearch icon should trigger an api endpoint call to be made, which will then search for the product with the specified id
const SearchBar = () => {
  ...
  const handleSearch = (e: { target: { value: string } }) => {
    ...
    setActiveSearch(
      productNames.filter((w) => w.includes(e.target.value)).slice(0, 8)
    );
  };
  return (
    <div className="flex">
